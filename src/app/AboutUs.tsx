  ...
  return (
    <section className={cn(
      ...
      <div>
        ...
        <h2 className="text-xl">Core Competencies</h2>
        <h3>Technical:</h3>
        <ul
          className={
            cn(
        ...
        >
          ...
          <li>Information Systems, Network Administration & Cyber Security</li>
        ...
        <p>
          Product Management, Strategy, Psychiatry & Psychology, Family
          Medicine, Health Law, Employment Law, Pharmaceuticals, Medical Writing
        </p>
